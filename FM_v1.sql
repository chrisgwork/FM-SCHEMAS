...
ALTER TABLE person                     MODIFY person_id                    INT(10) AUTO_INCREMENT;
...
ALTER TABLE film_actor_mapping        ADD CONSTRAINT fk_fam_person_id                  FOREIGN KEY (person_id)               REFERENCES person(person_id);
...
ALTER TABLE film_rating               ADD CONSTRAINT fk_fr_person_id                   FOREIGN KEY (person_id)               REFERENCES person(person_id);
...
ALTER TABLE reviewer_house_membership ADD CONSTRAINT fk_rhm_person_id                  FOREIGN KEY (person_id)               REFERENCES person(person_id);